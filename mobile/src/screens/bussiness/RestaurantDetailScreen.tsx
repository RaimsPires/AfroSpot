        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={[styles.header, { backgroundColor: colors.background }]}>
                <View style={styles.headerLeft}>
                    ...
                    <Text style={[styles.headerTitle, { color: colors.text }]}>Mama Ashanti's Kitchen</Text>
                </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                >
                    <View style={styles.heroOverlay}>
                        ...
                        <Text style={styles.heroTitleLarge}>Mama Ashanti's Kitchen</Text>
            ...
            <View style={styles.floatingCartContainer}>
                <TouchableOpacity style={[styles.cartBtn, { backgroundColor: colors.primary, shadowColor: colors.primary }]}>

import { Actions, Bubble, GiftedChat, IMessage, InputToolbar, Send } from '@tspvivek/react-native-gifted-chat';
...
const ChatScreen = () => {
    ...
    const renderActions = (props: any) => (
        <Actions
            ...
            icon={() => <AppIcon library="Feather" name="plus" size={24} color={colors.textSecondary} />}
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={{ flex: 1 }}>
                <GiftedChat
                    ...
                    alwaysShowSend
                    bottomOffset={Platform.OS === 'ios' ? 34 : 0} // Accounts for iOS home indicator
                />
            </View>
        </SafeAreaView>
    );

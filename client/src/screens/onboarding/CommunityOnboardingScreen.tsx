...
const styles = StyleSheet.create({
    ...
    logoCircle: { width: 50, height: 50, borderRadius: 15, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
    logoImage: { width: 30, height: 30 , resizeMode: 'contain' },
    logoText: { fontSize: 24, fontWeight: '900' },
    heroTextContent: { marginBottom: 20 },
    badge: { alignSelf: 'flex-start', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 8, marginBottom: 12, backgroundColor: '#22C55E' },

...
const BusinessDetailScreen = () => {
    const navigation = useNavigation<AppStackNavigationProp<'BusinessDetail'>>();
    const route = useRoute<AppStackRouteProp<'BusinessDetail'>>();
    const { colors } = useTheme();
    const businessId = route.params?.businessId ?? 'kushite-cutz-styles';
    const businessName = route.params?.businessName ?? 'Kushite Cutz & Styles';
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
                ...
                <View style={styles.heroContainer}>
                    ...
                    <View style={styles.heroOverlay}>
                        <SafeAreaView style={styles.headerTop}>
                            <TouchableOpacity onPress={() => navigation.goBack()} style={styles.iconBtnBlur}>
                ...
                <View style={styles.mainContent}>
                    ...
                    <View style={[styles.floatingCard, { backgroundColor: colors.background, shadowColor: colors.text }]}>
                        ...
                        <View style={styles.actionRow}>
                            ...
                            <ActionItem
                                ...
                                label="WhatsApp"
                                colors={colors}
                                onPress={() => navigation.navigate('Chat', { businessId, businessName })}
                            />
                            <ActionItem
                                icon="navigation"
                                label="Directions"
                                colors={colors}
                                onPress={() => navigation.navigate('InteractiveMap', { businessId })}
                            />
                        ...
                        <ServiceCard
                            ...
                            onAdd={() =>
                                navigation.navigate('Booking', {
                                    businessId,
                                    businessName,
                                    serviceType: 'Premium Fade & Style',
                                })
                            }
                        />
                        <ServiceCard
                            ...
                            onAdd={() =>
                                navigation.navigate('Booking', {
                                    businessId,
                                    businessName,
                                    serviceType: 'Beard Grooming & Shape',
                                })
                            }
                        />
                        <ServiceCard
                            ...
                            onAdd={() =>
                                navigation.navigate('Booking', {
                                    businessId,
                                    businessName,
                                    serviceType: 'Full Grooming Experience',
                                })
                            }
                        />

                        <TouchableOpacity
                            onPress={() => navigation.navigate('ProductMarketplace', { businessId })}
                    ...
                    <View style={styles.section}>
                        <View style={styles.sectionHeader}>
                            ...
                            <TouchableOpacity
                                onPress={() => navigation.navigate('Reviews', { businessId, source: 'write-review' })}
                        ...
                        <TouchableOpacity
                            onPress={() => navigation.navigate('Reviews', { businessId, source: 'business-detail' })}
                            style={styles.viewAllBtn}
                        >
                            ...
                            <SimilarCard
                                ...
                                onPress={() =>
                                    navigation.navigate('BusinessDetail', {
                                        businessId: 'heritage-braids',
                                        businessName: 'Heritage Braids',
                                        source: 'similar-businesses',
                                    })
                                }
                            />
                            <SimilarCard
            ...
            <View style={[styles.footer, { backgroundColor: colors.background, borderTopColor: colors.border }]}>
                <TouchableOpacity
                    onPress={() => navigation.navigate('Chat', { businessId, businessName })}
                    style={[styles.footerOutlineBtn, { borderColor: colors.primary }]}
                > 
                ...
                <View style={{ flex: 1.5 }}>
                    <AppButton
                        ...
                        onPress={() => navigation.navigate('Booking', { businessId, businessName })}
                    />
                </View>
            </View>
        </View>
...
const ActionItem = ({ icon, label, colors, onPress }: any) => (
...
const ServiceCard = ({ title, price, duration, desc, colors, onAdd }: any) => (
    <View style={[styles.serviceCard, { borderColor: colors.border }]}>
        <View style={styles.serviceHeader}>
            ...
            <TouchableOpacity onPress={onAdd} style={[styles.addBtn, { borderColor: colors.primary }]}> 
...
const SimilarCard = ({ image, title, type, rating, dist, colors, onPress }: any) => (
    <TouchableOpacity onPress={onPress} style={[styles.similarCard, { borderColor: colors.border }]}> 

...
export const LikesBottomSheet = ({ users = MOCK_LIKERS, likeCountLabel, onClose }: LikesBottomSheetProps) => {
    ...
    <View style={[styles.overlay, { backgroundColor: colors.overlay }]}> 
      <View style={[styles.sheet, { backgroundColor: colors.background }]}> 
        <View style={[styles.sheetHeader, { borderBottomColor: colors.divider }]}> 
          <Text style={[styles.headerTitle, { color: colors.text }]}>Likes ({likeCountLabel || users.length})</Text>

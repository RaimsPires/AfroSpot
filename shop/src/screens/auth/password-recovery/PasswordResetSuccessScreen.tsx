    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}> 
            ...
            <View style={styles.successContainer}>
                ...
                >
                    <Text style={[styles.mainBtnText, { color: colors.textInverse }]}>Back to Login</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    successCircle: { width: 96, height: 96, borderRadius: 48, alignItems: 'center', justifyContent: 'center', marginBottom: 32, elevation: 5, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 10 },
